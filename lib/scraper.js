...
module.exports = function getVersions (options) {
  fetch(options.baseUrl + 'index.json').then(JSON.parse).then(function (distributions) {
    ...
    .filter(function (build) {
      return !build.fileExists(options.definitionPaths) || options.overwrite
    })
    .map(function (build) {
